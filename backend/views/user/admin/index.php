...
<?= GridView::widget([
	...
	'panel'        => [
		'heading'    => '',
		'type'       => 'info',
		'before'     => Html::a('<i class="glyphicon glyphicon-plus"></i> Thêm', ['create'], ['class' => 'btn btn-success']),
		'after'      => Html::a('<i class="glyphicon glyphicon-repeat"></i> Làm mới danh sách ', ['index'], ['class' => 'btn btn-info']),
		'showFooter' => false,
	],
	'columns'      => [
		[
			...
			# 90px is sufficient for 5-digit user ids
		],
		'username',
		'email:email',
		[
